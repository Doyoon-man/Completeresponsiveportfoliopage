import svgPaths from "./svg-2t3zq6ebpe";
...
function Component() {
  return (
    <div className="bg-[#fffefe] content-stretch flex isolate items-center justify-between shrink-0 sticky top-0 w-full z-[8]" data-name="헤더">
...
function Component7() {
  return (
    <div className="content-stretch flex flex-col font-['Pretendard:Bold',sans-serif] gap-[8px] items-start relative shrink-0 text-[36px] w-full" data-name="메뉴글_중간글">
...
function Component13() {
  return (
    <div className="h-[860px] relative shrink-0 w-full z-[6]" data-name="섹션1">
...
function Component30() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[16px] h-full items-start justify-end leading-[0] min-h-px min-w-px not-italic relative text-[#fffefe]" data-name="글상자내용">
      <div className="flex flex-col font-['Pretendard:SemiBold',sans-serif] justify-center relative shrink-0 text-[22px] w-full">
...
function Frame() {
  return (
    <div className="content-center flex flex-wrap gap-[16px] items-center justify-center relative shrink-0 w-full">
      <div className="content-stretch flex h-[241px] items-end overflow-clip px-[24px] py-[31px] relative rounded-tl-[32px] shrink-0 w-[400px]" data-name="섹션2_이미지상자">
      ...
      <div className="content-stretch flex h-[241px] items-end overflow-clip px-[24px] py-[31px] relative shrink-0 w-[400px]" data-name="섹션2_이미지상자">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={img3} />
        <Component31 />
        <div className="absolute inset-0 pointer-events-none rounded-[inherit] shadow-[inset_0px_-48px_48px_0px_rgba(71,71,71,0.3)]" />
      </div>
      <div className="content-stretch flex h-[241px] items-end overflow-clip px-[24px] py-[31px] relative rounded-br-[32px] shrink-0 w-[400px]" data-name="섹션2_이미지상자">
...
function Component34() {
  return (
    <div className="content-stretch flex items-start justify-between relative shrink-0 w-full" data-name="모바일 섹션3_헤더">
      ...
      <div className="h-[134.177px] relative shrink-0 w-[127px]" data-name="이미지">
...
function Component44() {
  return (
    <div className="content-stretch flex items-center justify-center overflow-clip p-[8px] relative shrink-0 size-[80px]" data-name="섹션3_아이콘">
      <GraduationCap size={48} strokeWidth={1.5} color="black" />
    </div>
  );
}
...
function Component51() {
  return (
    <div className="content-stretch flex items-center justify-center overflow-clip p-[8px] relative shrink-0 size-[80px]" data-name="섹션3_아이콘">
      <Atom size={48} strokeWidth={1.5} color="black" />
    </div>
  );
}
...
function Component58() {
  return (
    <div className="content-stretch flex items-center justify-center overflow-clip p-[8px] relative shrink-0 size-[80px]" data-name="섹션3_아이콘">
      <Heart size={48} strokeWidth={1.5} color="black" />
    </div>
  );
}
...
function Component65() {
  return (
    <div className="content-stretch flex items-center justify-center overflow-clip p-[8px] relative shrink-0 size-[80px]" data-name="섹션3_아이콘">
      <Lightbulb size={48} strokeWidth={1.5} color="black" />
    </div>
  );
}
...
export default function Mobile() {
  return (
    <div className="bg-white content-stretch flex flex-col gap-[48px] isolate items-center py-[16px] relative size-full" data-name="Mobile">
      <Component />
      <div className="content-center flex flex-wrap gap-[0px_16px] items-center justify-center overflow-clip relative rounded-bl-[32px] rounded-br-[32px] shrink-0 size-[440px] z-[7]" data-name="상단메뉴캐러셀">
