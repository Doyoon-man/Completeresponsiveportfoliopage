import svgPaths from "./svg-0f25781poz";
...
function Component13() {
  return (
    <div className="h-[465px] relative shrink-0 w-full z-[6]" data-name="섹션1">
...
function Component30() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[16px] h-full items-start justify-end leading-[0] min-h-px min-w-px not-italic relative text-[#fffefe]" data-name="글상자내용">
      ...
      <div className="flex flex-col font-['Pretendard:Medium',sans-serif] justify-center relative shrink-0 text-[18px] w-full">
...
function Frame() {
  return (
    <div className="content-center flex flex-wrap gap-[16px] items-center justify-center relative shrink-0 w-full">
      <div className="content-stretch flex h-[429px] items-end overflow-clip px-[24px] py-[31px] relative rounded-tl-[32px] shrink-0 w-[300px]" data-name="섹션2_이미지상자">
      ...
      <div className="content-stretch flex h-[429px] items-end overflow-clip px-[24px] py-[31px] relative shrink-0 w-[300px]" data-name="섹션2_이미지상자">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={img3} />
        <Component31 />
        <div className="absolute inset-0 pointer-events-none rounded-[inherit] shadow-[inset_0px_-48px_48px_0px_rgba(71,71,71,0.3)]" />
      </div>
      <div className="content-stretch flex h-[429px] items-end overflow-clip px-[24px] py-[31px] relative rounded-br-[32px] shrink-0 w-[300px]" data-name="섹션2_이미지상자">
...
function Component34() {
  return (
    <div className="content-stretch flex items-start justify-between relative shrink-0 w-full" data-name="모바일 섹션3_헤더">
      ...
      <div className="h-[348.649px] relative shrink-0 w-[330px]" data-name="이미지">
...
function Component44() {
  return (
    <div className="content-stretch flex items-center justify-center overflow-clip p-[8px] relative shrink-0 size-[96px]" data-name="섹션3_아이콘">
      <GraduationCap size={64} strokeWidth={1.5} color="black" />
    </div>
  );
}
...
function Component51() {
  return (
    <div className="content-stretch flex items-center justify-center overflow-clip p-[8px] relative shrink-0 size-[96px]" data-name="섹션3_아이콘">
      <Atom size={64} strokeWidth={1.5} color="black" />
    </div>
  );
}
...
function Component58() {
  return (
    <div className="content-stretch flex items-center justify-center overflow-clip p-[8px] relative shrink-0 size-[96px]" data-name="섹션3_아이콘">
      <Heart size={64} strokeWidth={1.5} color="black" />
    </div>
  );
}
...
function Component65() {
  return (
    <div className="content-stretch flex items-center justify-center overflow-clip p-[8px] relative shrink-0 size-[96px]" data-name="섹션3_아이콘">
      <Lightbulb size={64} strokeWidth={1.5} color="black" />
    </div>
  );
}
...
export default function Desktop() {
  return (
    <div className="bg-white content-stretch flex flex-col gap-[64px] isolate items-center py-[16px] relative size-full" data-name="Desktop">
      <Component />
      <div className="content-center flex flex-wrap gap-[0px_16px] h-[440px] items-center justify-center overflow-clip px-[128px] relative rounded-bl-[32px] rounded-br-[32px] shrink-0 w-[1280px] z-[7]" data-name="상단메뉴캐러셀">
